...
function criaBotao (sTexto, sTitulo, sConteudo, iTipo, oElemento)
{
    ...
    oBotao.addEventListener('click', function(evt)
    {
        ...
        if (!oTexto.IsDirty() || confirm('Todo o texto já digitado será apagado.\nConfirma?')) {
            oTexto.SetHTML('<html lang="pt-BR" dir="ltr"><head><title>' + sTitulo.replace(/<[^>]+>/g, '') + '</title><style type="text/css">.header { font-family: Arial; font-size: 10pt; } .title { font-family: Times New Roman; font-size: 14pt; font-weight: bold; } .text { font-family: Times New Roman; font-size: 13pt; } .signature { font-family: Times New Roman; font-size: 12pt; font-weight: bold; font-style: italic; }</style></head><body bgcolor="white"><div class="header" align="center"><img width="85" height="93" src="http://intranet.jfsc.gov.br/nucleos/ninf/bibli_img/TRF4_1,44X1,57-30o%20dpi.jpg"></div><div class="header" align="center">PODER JUDICIÁRIO</div><div class="header" align="center"><strong>JUSTIÇA FEDERAL</div><div class="header" align="center"></strong>' + GM_getValue('v1.secao') + '</div><div class="header" align="center">' + GM_getValue('v1.subsecao') + '</div><div class="header" align="center">' + GM_getValue('v1.vara') + '</div><p class="text" align="justify">&nbsp;</p><p class="title" align="center">' + sTitulo + '</p><p class="text" align="justify">&nbsp;</p><p class="text" align="justify">' + sConteudo + '</p><p class="text" align="justify">&nbsp;</p><p class="text" align="justify">&nbsp;</p><p class="text" align="justify">&nbsp;</p><p class="signature" align="center">documento assinado eletronicamente</p></body></html>');
