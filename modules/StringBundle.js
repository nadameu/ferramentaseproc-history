/**
 * @name resource://eproc/StringBundle.js
 * @fileOverview Define a classe StringBundle
 * @author Mozilla
 * @author Myk Melez
 */
/*******************************************************************************
 ...
 * </p>
 * <p>
 * To use this module, import it, create a new instance of StringBundle, and
 * then use the instance's |get| and |getAll| methods to retrieve strings (you
 * can get both plain and formatted strings with |get|):
 * </p>
 * 
 * <pre><code>
 ...
 * @constructor
 * @param url
 *            {String} the URL of the string bundle
 */
...
StringBundle.prototype = {
  ...
  /**
	 ...
	 * 
	 * @param key
	 *            {String} the identifier of the string to get
	 * @param args
	 *            {array} [optional] an array of arguments that replace
	 *            occurrences of %S in the string
	 * 
  ...
  /**
	 * the locale associated with the application
	 * 
	 * @deprecated because it has never been used outside the XBL binding
	 *             itself, and consumers should obtain it directly from the
	 *             locale service anyway.
	 * @type nsILocale
	 */
  get appLocale() {
  ...
  /**
	 * the wrapped nsIStringBundle
	 * 
	 * @deprecated because this module should provide all necessary
	 *             functionality
	 * @type nsIStringBundle
	 * 
  ...
  /**
	 ...
	 *            {string} the identifier of the string to get
	 * @param args
	 *            {array} an array of arguments that replace occurrences of %S
	 *            in the string
	 * 
	 * @returns {String} the formatted value of the string
	 */
  ...
  /**
	 ...
	 * 
	 * @returns {nsISimpleEnumerator} a enumeration of the strings in the bundle
	 */
  get strings() {
